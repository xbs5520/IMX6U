...
static iomux_v3_cfg_t const fec1_pads[] = {
	...
	MX6_PAD_SNVS_TAMPER7__GPIO5_IO07 | MUX_PAD_CTRL(NO_PAD_CTRL), 	// set RST pin config
};
...
static iomux_v3_cfg_t const fec2_pads[] = {
	...
	MX6_PAD_SNVS_TAMPER8__GPIO5_IO08 | MUX_PAD_CTRL(NO_PAD_CTRL),  // set RST pin config
};
